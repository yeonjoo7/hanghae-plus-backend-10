...
class ProductControllerTest {
        ...
        // RedisConfig가 로드될 때 필요한 ConnectionFactory를 Mock으로 제공
        @MockBean
        ...
        @MockBean
        private com.hanghae.ecommerce.infrastructure.cache.PopularProductCache popularProductCache;
        ...
        void getPopularProducts_Success() throws Exception {
                ...
                List<ProductService.PopularProduct> popularProducts = List.of(
                                new ProductService.PopularProduct(
                                                ...
                                                null, 100, java.time.LocalDate.now().minusDays(7),
                                                java.time.LocalDate.now()),
                                new ProductService.PopularProduct(
                                                2, Product.create("인기상품2", "설명2", Money.of(20000), Quantity.of(3)),
                                                null, 80, java.time.LocalDate.now().minusDays(7),
                                                java.time.LocalDate.now()));
