...
public interface CartItemRepository extends JpaRepository<CartItem, Long> {
         ...
         */
        Optional<CartItem> findByCartIdAndProductIdAndProductOptionId(Long cartId, Long productId,
         ...
         * @Query("SELECT ci FROM CartItem ci WHERE ci.cartId = :cartId AND ci.state = :state"
         * )
         * List<CartItem> findByCartIdAndState(@Param("cartId") Long
         * cartId, @Param("state") CartItemState state);
         * 
         * @Query("SELECT ci FROM CartItem ci WHERE ci.cartId = :cartId AND ci.productId = :productId AND ci.state = :state"
         * )
         * Optional<CartItem> findByCartIdAndProductIdAndState(@Param("cartId") Long
         * cartId, @Param("productId") Long productId, @Param("state") CartItemState
         * state);
         */
