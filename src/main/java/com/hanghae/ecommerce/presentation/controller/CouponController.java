...
public class CouponController {
        ...
        try {
            ...
            IssueCouponResponse response = new IssueCouponResponse(
                ...
                couponInfo.getCoupon().getDiscountPolicy().hasMinOrderAmount() ? 
                    couponInfo.getCoupon().getDiscountPolicy().getMinOrderAmount().getValue() : 0,
    ...
    public ApiResponse<CouponUsageHistoryResponse> getCouponUsageHistory(
        ...
        CouponUsageHistoryResponse.Pagination pagination = 
            new CouponUsageHistoryResponse.Pagination(pageNum, totalPages, totalItems, pageSize);
